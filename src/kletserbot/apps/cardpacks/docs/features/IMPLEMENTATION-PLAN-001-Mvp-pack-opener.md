...
- Create: `src/kletserbot/apps/cardpacks/domain/__init__.py`
- Create: `src/kletserbot/apps/cardpacks/domain/pokemon_card.py`
- Create: `src/kletserbot/apps/cardpacks/domain/pack_configuration.py`
- Create: `src/kletserbot/apps/cardpacks/domain/opened_pack.py`
- Create: `src/kletserbot/apps/cardpacks/domain/pack_generator.py`
- Test: `tests/unit/apps/cardpacks/domain/test_pack_configuration.py`
...
Run:
`pytest tests/unit/apps/cardpacks/domain/test_pack_configuration.py tests/unit/apps/cardpacks/domain/test_pack_generator.py -v`
...
Run:
`ruff check src/kletserbot/apps/cardpacks/domain tests/unit/apps/cardpacks/domain`
...
- Create: `src/kletserbot/apps/cardpacks/application/card_set_configuration_provider.py`
- Create: `src/kletserbot/apps/cardpacks/infrastructure/__init__.py`
- Create: `src/kletserbot/apps/cardpacks/infrastructure/json_card_set_configuration_provider.py`
- Create: `src/kletserbot/apps/cardpacks/infrastructure/config/sets.json`
- Create: `src/kletserbot/apps/cardpacks/infrastructure/config/pull_rates.json`
- Test:
...
Run:
`pytest tests/unit/apps/cardpacks/infrastructure/test_json_card_set_configuration_provider.py -v`
...
Run:
`ruff check src/kletserbot/apps/cardpacks/application
src/kletserbot/apps/cardpacks/infrastructure
tests/unit/apps/cardpacks/infrastructure`

Run: `mypy src/kletserbot/apps/cardpacks/domain
src/kletserbot/apps/cardpacks/application
src/kletserbot/apps/cardpacks/infrastructure`
...
- Create: `src/kletserbot/apps/cardpacks/application/pack_inventory_repository.py`
- Create: `src/kletserbot/apps/cardpacks/application/dto/pack_inventory_dto.py`
- Create: `src/kletserbot/apps/cardpacks/application/dto/__init__.py`
- Create: `src/kletserbot/apps/cardpacks/infrastructure/sqlite_pack_inventory_repository.py`
- Test:
  `tests/integration/apps/cardpacks/infrastructure/test_sqlite_pack_inventory_repository.py`
...
Run:
`pytest tests/integration/apps/cardpacks/infrastructure/test_sqlite_pack_inventory_repository.py -v`
...
Run:
`ruff check src/kletserbot/apps/cardpacks/infrastructure/sqlite_pack_inventory_repository.py
tests/integration/apps/cardpacks/infrastructure/test_sqlite_pack_inventory_repository.py`

Run:
`mypy src/kletserbot/apps/cardpacks/application
src/kletserbot/apps/cardpacks/infrastructure/sqlite_pack_inventory_repository.py`
...
- Create: `src/kletserbot/apps/cardpacks/application/pokemon_card_gateway.py`
- Create: `src/kletserbot/apps/cardpacks/application/pokemon_card_cache.py`
- Create: `src/kletserbot/apps/cardpacks/infrastructure/pokemon_tcg_client.py`
- Create: `src/kletserbot/apps/cardpacks/infrastructure/json_pokemon_card_cache.py`
- Test: `tests/integration/apps/cardpacks/infrastructure/test_pokemon_tcg_client.py`
- Test: `tests/integration/apps/cardpacks/infrastructure/test_json_pokemon_card_cache.py`
...
Run:
`pytest tests/integration/apps/cardpacks/infrastructure/test_pokemon_tcg_client.py
tests/integration/apps/cardpacks/infrastructure/test_json_pokemon_card_cache.py -v`
...
Run:
`ruff check src/kletserbot/apps/cardpacks/infrastructure
tests/integration/apps/cardpacks/infrastructure`

Run:
`mypy src/kletserbot/apps/cardpacks/application src/kletserbot/apps/cardpacks/infrastructure`
...
- Create: `src/kletserbot/apps/cardpacks/application/cardpack_service.py`
- Create: `src/kletserbot/apps/cardpacks/application/dto/available_card_set_dto.py`
- Create: `src/kletserbot/apps/cardpacks/application/dto/opened_card_dto.py`
- Create: `src/kletserbot/apps/cardpacks/application/dto/opened_pack_dto.py`
...
Run: `pytest tests/unit/apps/cardpacks/application/test_cardpack_service.py -v`
...
Run: `mypy src/kletserbot/apps/cardpacks/application`
...
Run:
`pytest tests/unit/apps/cardpacks/presentation/discord/test_cardpack_commands.py
