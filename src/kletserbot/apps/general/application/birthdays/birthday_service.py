...
from kletserbot.apps.general.application.birthdays.birthday_provider import BirthdayProvider
from kletserbot.apps.general.application.birthdays.dto.birthday_announcement_dto import (
    BirthdayAnnouncementDto,
)
from kletserbot.apps.general.domain.birthdays.birthday_calculator import (
