...
from kletserbot.apps.general.application.exceptions import EmptyContentError
from kletserbot.apps.general.application.quotes.dto.quote_dto import QuoteDto
from kletserbot.apps.general.application.quotes.quote_provider import QuoteProvider
