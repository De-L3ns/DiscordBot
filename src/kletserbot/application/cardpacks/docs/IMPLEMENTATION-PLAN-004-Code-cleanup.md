...
- Modify: `src/kletserbot/infrastructure/cardpacks/config/sets.json`
- Modify:
  `src/kletserbot/infrastructure/cardpacks/json_card_set_configuration_provider.py`
- Modify: `src/kletserbot/domain/cardpacks/pack_configuration.py`
- Modify: `src/kletserbot/domain/cardpacks/opened_pack.py`
- Modify: `src/kletserbot/domain/cardpacks/pack_generator.py`
- Modify: `src/kletserbot/application/cardpacks/cardpack_service.py`
- Modify: `src/kletserbot/application/cardpacks/dto/*.py`
...
- Modify: `src/kletserbot/domain/cardpacks/pack_configuration.py`
- Modify: `tests/unit/domain/cardpacks/test_pack_configuration.py`
- Modify: `tests/unit/domain/cardpacks/test_pack_generator.py`
