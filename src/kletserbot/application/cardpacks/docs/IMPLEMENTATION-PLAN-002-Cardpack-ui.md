...
- Modify: `src/kletserbot/infrastructure/cardpacks/config/pull_rates.json`
- Modify: `src/kletserbot/application/cardpacks/dto/opened_card_dto.py`
- Modify: `src/kletserbot/application/cardpacks/cardpack_service.py`
- Test: `tests/unit/domain/cardpacks/test_pack_generator.py`
- Test: `tests/unit/application/cardpacks/test_cardpack_service.py`
- Test: `tests/unit/infrastructure/cardpacks/test_json_card_set_configuration_provider.py`
...
```bash
pytest -q tests/unit/domain/cardpacks/test_pack_generator.py \
  tests/unit/application/cardpacks/test_cardpack_service.py \
...
```bash
pytest -q tests/unit/presentation/discord/test_cardpack_views.py \
...
- Modify if needed:
  `src/kletserbot/application/cardpacks/docs/DESIGN-002-Cardpack-ui.md`
- Modify if needed:
  `src/kletserbot/application/cardpacks/docs/IMPLEMENTATION-PLAN-002-Cardpack-ui.md`
